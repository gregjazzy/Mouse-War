// 🚫 DÉTECTION TÉLÉPHONE - BLOQUER UNIQUEMENT LES TÉLÉPHONES (PAS LES TABLETTES)
(function() {
    const isMobilePhone = (/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) 
                          && window.innerWidth < 600)  // Seulement si < 600px (téléphones)
                          || (window.innerWidth < 600 && window.innerHeight < 900); // Petits écrans
    
    if (isMobilePhone) {
        // Afficher message téléphone bloqué
            ...
            document.body.innerHTML = `
                ...
                ">
                    ...
                    ">
                        ...
                        <h1 style="font-size: 2rem; margin-bottom: 1rem;">Maze Mouse</h1>
                        <div style="font-size: 4rem; margin: 1rem 0;">🧀🐭</div>
                        <h2 style="font-size: 1.5rem; margin-bottom: 1.5rem; color: #FFE66D;">
                            Jouez sur Ordinateur ou Tablette !
                        </h2>
                        <p style="font-size: 1.1rem; line-height: 1.6; margin-bottom: 2rem;">
                            Ce jeu est optimisé pour <strong>PC/Mac/Tablette</strong>.<br><br>
                            Écran requis : <strong>600px minimum</strong><br>
                            Votre écran : <strong>${window.innerWidth}px</strong><br><br>
                            Ouvrez ce lien sur un appareil plus grand :
                        </p>
                        <div style="
                            ...
                            margin-bottom: 2rem;
                        ">
                            gregjazzy.github.io/Mouse-War
                        </div>
                        <p style="font-size: 0.9rem; opacity: 0.8;">
                            📱 Téléphone : ❌ Trop petit<br>
                            📱 Tablette (iPad, etc.) : ✅ OK !<br>
                            🖥️ Ordinateur : ✅ Parfait !
                        </p>
                    </div>
                </div>
            `;
        ...
        // Empêcher tout chargement du reste du jeu
        throw new Error('Téléphone non supporté - Utilisez tablette ou PC');
    }
})();
